      ...
      <div class="part part3">
        <Card :bordered="false">
          ...
          <FormItem prop="c3" label="商标" style="width:100%" :label-width="180">
            <Input type="text" v-model="formRecord.c3" :disabled='disabledoff' placeholder="商标"/>
          </FormItem>
              ...
              <td>
                <FormItem prop="c34">
                  <CheckboxGroup v-model="formRecord.c34">
                    <Checkbox label="1.0/（1GB)×（微型计算机总内存容量＿＿GB--基本内存容量＿＿GB）" :disabled='disabledoff || forbidden.c34'>1.0 /(1GB)×(微型计算机总内存容量</Checkbox>
                  </CheckboxGroup>
                </FormItem>
                <br>
              ...
              <td colspan="3">
                <FormItem prop="c37">
                  <CheckboxGroup v-model="formRecord.c37">
                    <Checkbox label="0.4/（1GB)×（微型计算机总内存容量＿＿GB--基本内存容量＿＿GB）" :disabled='disabledoff || forbidden.c37'>0.4/(1GB)×(微型计算机总内存容量</Checkbox>
                  </CheckboxGroup>
                </FormItem>
                <br>
    ...
    <Modal v-model="modal4" :width=820 :footer-hide=true>
     ...
     <Modal v-model="modal5" class="basic-info"  :width=650 ok-text="保存"  @on-ok="submitBasic" cancel-text="关闭">
       ...
       <div class="pro-info">
          ...
          型号的 <span  class="f-product">微型计算机 2012版</span>产品。
       </div>
