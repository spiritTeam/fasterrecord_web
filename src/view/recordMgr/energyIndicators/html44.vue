    ...
    <Form ref="formRecord" :model="formRecord" label-position="right" :rules="ruleRecord">
      ...
      <div class="part part3">
        <Card :bordered="false">
          ...
          <div class="ivu-form-item ivu-form-item-required ivu-form-item-error" v-if="checkComplex!=''">
          ...
          <table id="table1">
            <tr>
              <td class="t_label">全年综合性能系数/(W/W)</td>
              <td style="text-align:center">/</td>
              <td class="t_label" style="border-right:none;"><span class="red">*</span>标注值:</td>
              ...
              <td style="border-left:none;">
                <FormItem prop="c10">
                  <Input type="text" v-model="formRecord.c10" :disabled='disabledoff' placeholder="三位小数"/>
                </FormItem>
              </td>
              <td>
            ...
            <tr>
              <td class="t_label">名义制冷量</td>
              <td class="t_label">
                <FormItem prop="c49" label="单位" style="width:100%;" :label-width="100">
                  <RadioGroup v-model="formRecord.c49">
                    <Radio label="kW" :disabled='disabledoff'></Radio>
                    <Radio label="W"  :disabled='disabledoff'></Radio>
                  </RadioGroup>
                </FormItem>
              </td>
              <td class="t_label" style="border-right:none;"><span class="red">*</span>标注值:</td>
              <td style="border-left:none;">
                <FormItem prop="c12">
                  <Input type="text" v-model="formRecord.c12" :disabled='disabledoff' :placeholder='formRecord.c49=="kW"?"一位小数":"整数"'/>
                </FormItem>
              </td>
              <td class="t_label" style="border-right:none;"><span class="red">*</span>实测值:</td>
              <td style="border-left:none;">
                <FormItem prop="c13">
                  <Input type="text" v-model="formRecord.c13" :disabled='disabledoff' :placeholder='formRecord.c49=="kW"?"至少两位小数":"至少一位小数"'/>
                </FormItem>
              </td>
              <td>
            ...
            <tr>
              <td class="t_label">名义制冷消耗功率</td>
              <td class="t_label">
                <FormItem prop="c50" label="单位" style="width:100%;" :label-width="100">
              ...
              <td style="border-left:none;">
                <FormItem prop="c15">
                  <Input type="text" v-model="formRecord.c15" :disabled='disabledoff' :placeholder='formRecord.c50=="kW"?"一位小数":"整数"'/>
                </FormItem>
              </td>
              <td class="t_label" style="border-right:none;"><span class="red">*</span>实测值:</td>
              <td style="border-left:none;">
                <FormItem prop="c16">
                  <Input type="text" v-model="formRecord.c16" :disabled='disabledoff' :placeholder='formRecord.c50=="kW"?"至少两位小数":"至少一位小数"'/>
                </FormItem>
              </td>
              <td>
            ...
            <tr>
              <td class="t_label">名义制热量</td>
              <td class="t_label">
                <FormItem prop="c51" label="单位" style="width:100%;" :label-width="100">
              ...
              <td style="border-left:none;">
                <FormItem prop="c18">
                  <Input type="text" v-model="formRecord.c18" :disabled='disabledoff' :placeholder='formRecord.c51=="kW"?"一位小数":"整数"'/>
                </FormItem>
              </td>
              <td class="t_label" style="border-right:none;"><span class="red">*</span>实测值:</td>
              <td style="border-left:none;">
                <FormItem prop="c19">
                  <Input type="text" v-model="formRecord.c19" :disabled='disabledoff' :placeholder='formRecord.c51=="kW"?"至少两位小数":"至少一位小数"'/>
                </FormItem>
              </td>
              <td>
            ...
            <tr>
              <td class="t_label">名义制热消耗功率</td>
              <td class="t_label">
                <FormItem prop="c52" label="单位" style="width:100%;" :label-width="100">
              ...
              <td style="border-left:none;">
                <FormItem prop="c21">
                  <Input type="text" v-model="formRecord.c21" :disabled='disabledoff' :placeholder='formRecord.c52=="kW"?"一位小数":"整数"'/>
                </FormItem>
              </td>
              <td class="t_label" style="border-right:none;"><span class="red">*</span>实测值:</td>
              <td style="border-left:none;">
                <FormItem prop="c22">
                  <Input type="text" v-model="formRecord.c22" :disabled='disabledoff' :placeholder='formRecord.c52=="kW"?"至少两位小数":"至少一位小数"'/>
                </FormItem>
              </td>
              <td>
      ...
      <div class="part part5">
        <Card :bordered="false">
          ...
          <table id="table3">
            <tr>
              <td class="t_label"><span class="red">*</span>机器类型</td>
              <td colspan="3">
                <FormItem prop="c25">
            ...
            <tr>
              <td class="t_label"><span class="red">*</span>冷(热)源类型</td>
              <td colspan="3">
                <FormItem prop="c26">
            ...
            <tr>
              <td class="t_label"><span class="red">*</span>结构形式</td>
              <td colspan="3">
                <FormItem prop="c27">
            ...
            <tr>
              <td class="t_label"><span class="red">*</span>换热器(水/制冷剂)</td>
              <td colspan="3">
                <FormItem prop="c28">
            ...
            <tr>
              <td class="t_label"><span class="red">*</span>模块化</td>
              <td>
                <FormItem prop="c32">
              ...
              <td class="t_label"><span class="red">*</span>部分负荷运行</td>
              <td>
                <FormItem prop="c33">
            ...
            <tr>
              <td class="t_label"><span class="red">*</span>油分离器</td>
              <td>
                <FormItem prop="c34">
              ...
              <td class="t_label"><span class="red">*</span>储液器</td>
              <td>
                <FormItem prop="c35">
            ...
            <tr>
              <td class="t_label"><span class="red">*</span>辅助电加热器</td>
              <td colspan="3">
                <FormItem prop="c36">
            ...
            <tr>
              <td class="t_label"><span class="red">*</span>控制类型</td>
              <td colspan="3">
                <FormItem prop="c37">
            ...
            <tr>
              <td class="t_label"><span class="red">*</span>电源类型</td>
              <td colspan="3">
                <FormItem prop="c39">
            ...
            <tr>
              <td class="t_label"><span class="red">*</span>制冷剂</td>
              <td>
                <FormItem prop="c41">
                  <Input type="text" v-model="formRecord.c41" :disabled="disabledoff"/>
                </FormItem>
              </td>
              <td class="t_label"><span class="red">*</span>灌注量(kg)</td>
              <td>
                <FormItem prop="c45">
            ...
            <tr>
              <td class="t_label"><span class="red">*</span>整体或室外机外形尺寸<br/>(长×宽×高)(mm×mm×mm)</td>
              <td>
              ...
              <td class="t_label"><span class="red">*</span>室内机外形尺寸<br/>(长×宽×高)(mm×mm×mm)</td>
              <td>
      ...
      <div class="part part6">
        <Card :bordered="false">
          ...
          <table id="table4">
            ...
            <tbody>
            <tr>
              <td rowspan="4" class="t_label">1</td>
              <td rowspan="4" class="t_label">压缩机</td>
            ...
            <tr>
              <td rowspan="4" class="t_label">2</td>
              <td rowspan="4" class="t_label">风机</td>
              <td style="text-align:center">具体型号</td>
            ...
            <tr>
              <td rowspan="4" class="t_label">3</td>
              <td rowspan="4" class="t_label">换热器（水）</td>
              <td style="text-align:center">具体型号</td>
  ...
  computed: {
    ...
    ruleRecord() {
      ...
      let checkC12=(rule, value, callback) => {
        ...
        if (_c49=='W'&&!sCheck.number.isInteger(value)) _msg='整数';
      ...
      let checkC13=(rule, value, callback) => {
        ...
        if (_c49=='W'&&!sCheck.number.atLeastOneDecimals(value)) _msg='至少一位小数';
        if (_msg) callback(_msg);
        else callback();
      }
      let checkC15=(rule, value, callback) => {
        ...
        if (_c50=='W'&&!sCheck.number.isInteger(value)) _msg='整数';
        if (_msg) callback(_msg);
        else callback();
      }
      let checkC16=(rule, value, callback) => {
        ...
        if (_c50=='W'&&!sCheck.number.atLeastOneDecimals(value)) _msg='至少一位小数';
        if (_msg) callback(_msg);
        else callback();
      }
      let checkC18=(rule, value, callback) => {
        ...
        if (_c51=='W'&&!sCheck.number.isInteger(value)) _msg='整数';
        if (_msg) callback(_msg);
        else callback();
      }
      let checkC19=(rule, value, callback) => {
        ...
        if (_c51=='W'&&!sCheck.number.atLeastOneDecimals(value)) _msg='至少一位小数';
        if (_msg) callback(_msg);
        else callback();
      }
      let checkC21=(rule, value, callback) => {
        ...
        if (_c52=='W'&&!sCheck.number.isInteger(value)) _msg='整数';
        if (_msg) callback(_msg);
        else callback();
      }
      let checkC22=(rule, value, callback) => {
        ...
        if (_c52=='W'&&!sCheck.number.atLeastOneDecimals(value)) _msg='至少一位小数';
        if (_msg) callback(_msg);
        if (_msg) callback(_msg);
        else callback();
      }
      ...
      if (_c8=="冷热风型") {
        for (let thisC26 of _c26) {
          if (thisC26=="水环式") {
            ...
            if (_c9>=3.90 && _c9<4.20) _nxdj.push("2"), _c10val.push("3.90");
            else
            if (_c9>=3.50 && _c9<3.90) _nxdj.push("3"), _c10val.push("3.50");
          }
          else if (thisC26=="地下水式") {
            if (_c9>=4.50)             _nxdj.push("1"), _c10val.push("4.50");
            else
            if (_c9>=4.20 && _c9<4.50) _nxdj.push("2"), _c10val.push("4.20");
            else
            if (_c9>=3.80 && _c9<4.20) _nxdj.push("3"), _c10val.push("3.8");
          }
        ...
        for (let thisC26 of _c26) {
          if (thisC26=="水环式") {
            if (_c12<=str150) {
              ...
              if (_c9>=4.60 && _c9<5.00) _nxdj.push("2"), _c10val.push("4.60");
              else
              if (_c9>=3.80 && _c9<4.60) _nxdj.push("3"), _c10val.push("3.80");
            } else {
              if (_c9>=5.4)              _nxdj.push("1"), _c10val.push("5.4");
              else
              if (_c9>=5.00 && _c9<5.40) _nxdj.push("2"), _c10val.push("5.00");
              else
              if (_c9>=4.00 && _c9<5.00) _nxdj.push("3"), _c10val.push("4.00");
            }
          } else if (thisC26=="地下水式") {
            if (_c12<=str150) {
              if (_c9>=5.3)              _nxdj.push("1"), _c10val.push("5.3");
              else
              if (_c9>=4.90 && _c9<5.30) _nxdj.push("2"), _c10val.push("4.90");
              else
              if (_c9>=3.90 && _c9<4.90) _nxdj.push("3"), _c10val.push("3.90");
            } else {
              if (_c9>=5.90)             _nxdj.push("1"), _c10val.push("5.90");
              else
              if (_c9>=5.50 && _c9<5.90) _nxdj.push("2"), _c10val.push("5.50");
              else
              if (_c9>=4.40 && _c9<5.50) _nxdj.push("3"), _c10val.push("4.40");
            }
          } else if (thisC26=="地埋管式") {
            if (_c12<=str150) {
              if (_c9>=5.0)              _nxdj.push("1"), _c10val.push("5.0");
            ...
            if (_c12<=str150) {
              ...
              if (_c9>=4.60 && _c9<5.0)  _nxdj.push("2"), _c10val.push("4.60");
              else
              if (_c9>=3.80 && _c9<4.60) _nxdj.push("3"), _c10val.push("3.80");
            } else {
              if (_c9>=5.4)              _nxdj.push("1"), _c10val.push("5.4");
              else
              if (_c9>=5.00 && _c9<5.4)  _nxdj.push("2"), _c10val.push("5.00");
              else
              if (_c9>=4.00 && _c9<5.00) _nxdj.push("3"), _c10val.push("4.00");
            }
          }
