    ...
    <Form ref="formRecord" :model="formRecord" label-position="right" :rules="ruleRecord">
      ...
      <div class="part part3">
        <Card :bordered="false">
          ...
          <FormItem prop="c27" label="产品类型" :label-width="180">
      ...
      <div class="part part4">
        <Card :bordered="false">
          ...
          <FormItem prop="c26" label="备案标识开始使用日期" style="width:100%;">
            <DatePicker type="date" :options="dataInit" style="width: 200px" v-model="formRecord.c26"
          ...
          <table id="table3">
              ...
              <td>
                <FormItem prop="c34">
                  <CheckboxGroup v-model="formRecord.c34" style="display:inline-block;">
                    ...
                    <FormItem prop="c35">
                      <Input type="text" v-model="formRecord.c35" :disabled='disabledoff' style="width:80px;" />（kW）
                    </FormItem>
                    <Checkbox label="2" :disabled='disabledoff'>供暖</Checkbox>
                    <FormItem prop="c36">
                      <Input type="text" v-model="formRecord.c36" :disabled='disabledoff' style="width:80px;" />（kW）
                    </FormItem>
                  </CheckboxGroup>
                </FormItem>
              </td>
            ...
            <tr>
              ...
              <td>
                ...
                <FormItem prop="c58">
                  <Input type="text" v-model="formRecord.c58" :disabled='disabledoff' style="width:80px;" ></Input>
                </FormItem>
                ...
                <FormItem prop="c60">
                  <Input type="text" v-model="formRecord.c60" :disabled='disabledoff' style="width:80px;" ></Input>
                </FormItem>
              </td>
            </tr>
          </table>
        ...
        <Card :bordered="false">
          ...
          <table>
            <tr>
              ...
              <td>(JPG/PNG)</td>
              <td>
                <div class="lookOver" v-show="uploadParam.fileField24">
                  <Button @click="showImg(uploadParam.fileField24)" icon="ios-glasses-outline" type="primary">查看</Button>
                </div>
                <div>
                  <Upload
