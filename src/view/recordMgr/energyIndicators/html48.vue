      ...
      <div class="part part4">
        <Card :bordered="false">
          ...
          <FormItem prop="c26" label="备案标识开始使用日期" style="width:100%;">
            <DatePicker type="date" :options="dataInit" style="width: 200px" v-model="formRecord.c26"></DatePicker>
          </FormItem>
        </Card>
      </div>
    ...
    computed: {
      ...
      ruleRecord() {
        ...
        return {
          ...
          c57: [
            {
              trigger: 'change,blur', required: this.formRecord.c56.join('').indexOf('其它') > -1,
              message: '安全装置其它值不能为空'
            }
          ],
          c58: [
