<template>
  <div class="wrapper">
    <Form ref="formRecord" :model="formRecord" label-position="right" :rules="ruleRecord">
      <h1>家用太阳能热水系统2011版-修订能源效率标识备案表</h1>
          ...
          <table id="table3">
            <tr>
              ...
              <td colspan="3">
                ...
                <FormItem prop="c63">
                  <Input type="text" v-model="formRecord.c63" style="width:200px;"
                         :disabled='disabledoff || forbidden.c63'/>
                </FormItem>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td colspan="3">`
                ...
                <FormItem prop="c15">
                  <Input type="text" v-model="formRecord.c15" style="width:200px;"
                         :disabled='disabledoff || forbidden.c15'/>
                </FormItem>
            ...
            <tr>
              ...
              <td colspan="2">
                ...
                <FormItem prop="c17">
                  <Input type="text" v-model="formRecord.c17" style="width:200px;"
                         :disabled='disabledoff || forbidden.c17'/>
                </FormItem>
              </td>
            </tr>
            <tr>
              ...
              <td colspan="2">
                ...
                <FormItem prop="c19">
                  <Input type="text" v-model="formRecord.c19" style="width:200px;"
                         :disabled='disabledoff || forbidden.c19'/>
                </FormItem>
              </td>
            </tr>
            <tr>
              ...
              <td colspan="2">
                <FormItem prop="c20" :label-width="10">
                  长度:<Input type="text" v-model="formRecord.c20" style="width:100px;"
                            :disabled='disabledoff || forbidden.zkgx'/>m(一位小数)
                </FormItem>
                <FormItem prop="c21" :label-width="10">
                  直径:<Input type="text" v-model="formRecord.c21" style="width:100px;"
                            :disabled='disabledoff || forbidden.zkgx'/>mm
                </FormItem>
                <br/><br/>
                <FormItem prop="c22" :label-width="10">
                  根数:<Input type="text" v-model="formRecord.c22" style="width:100px;"
                            :disabled='disabledoff || forbidden.zkgx'/>
                </FormItem>
              </td>
            </tr>
            <tr>
              ...
              <td colspan="2">
                ...
                <FormItem prop="c24">
                  <Input type="text" v-model="formRecord.c24" style="width:200px;"
                         :disabled='disabledoff || forbidden.c24'/>
                </FormItem>
              </td>
            </tr>
            <tr>
              ...
              <td colspan="2">
                <FormItem prop="c25">
                  <Input type="text" v-model="formRecord.c25" style="width:200px;"
                         :disabled='disabledoff || forbidden.pbx'/>
                </FormItem>
              </td>
            </tr>
            <tr>
              ...
              <td colspan="2" width="1100px">
                ...
                <FormItem prop="c27">
                  <Input type="text" v-model="formRecord.c27" style="width:200px;"
                         :disabled='disabledoff || forbidden.c27'/>
                </FormItem>
              </td>
            </tr>
            <tr>
              ...
              <td colspan="2">
                ...
                <FormItem prop="c29">
                  <Input type="text" v-model="formRecord.c29" style="width:200px;"
                         :disabled='disabledoff || forbidden.c29'/>
                </FormItem>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td colspan="2">
                <FormItem prop="c30">
                  <Input type="text" v-model="formRecord.c30" style="width:200px;"
                         :disabled='disabledoff || forbidden.pbx'/>
                </FormItem>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td colspan="2">
                ...
                <FormItem prop="c32">
                  <Input type="text" v-model="formRecord.c32" style="width:200px;"
                         :disabled='disabledoff || forbidden.c32'/>
                </FormItem>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td colspan="2">
                ...
                <FormItem prop="c34">
                  <Input type="text" v-model="formRecord.c34" style="width:200px;"
                         :disabled='disabledoff || forbidden.c34'/>
                </FormItem>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td colspan="2">
                ...
                <FormItem prop="c36">
                  <Input type="text" v-model="formRecord.c36" style="width:200px;"
                         :disabled='disabledoff || forbidden.c36'/>
                </FormItem>
              </td>
            </tr>
            <tr>
              ...
              <td colspan="2">
                ...
                <FormItem prop="c38">
                  <Input type="text" v-model="formRecord.c38" style="width:200px;"
                         :disabled='disabledoff || forbidden.c38'/>
                </FormItem>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td colspan="3">
                <FormItem prop="c42" style="width:100%;" :label-width="10">
                  ...
                  <FormItem prop="c43">
                    <Input type="text" v-model="formRecord.c43" style="width:200px;"
                           :disabled='disabledoff || forbidden.c43'/>
                  </FormItem>
                </FormItem>
              </td>
            </tr>
            <tr>
              ...
              <td colspan="3">
                ...
                <FormItem prop="c45">
                  <Input type="text" v-model="formRecord.c45" style="width:200px;"
                         :disabled='disabledoff || forbidden.c45'/>
                </FormItem>
              </td>
            </tr>
            <tr>
              ...
              <td colspan="3">
                ...
                <FormItem prop="c47">
                  <Input type="text" v-model="formRecord.c47" style="width:200px;"
                         :disabled='disabledoff || forbidden.c47'/>
                </FormItem>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td colspan="3">
                ...
                <FormItem prop="c49">
                  <Input type="text" v-model="formRecord.c49" style="width:200px;"
                         :disabled='disabledoff || forbidden.c49'/>
                </FormItem>
              </td>
            </tr>
            <tr>
              ...
              <td colspan="3">
                ...
                <FormItem prop="c51">
                  <Input type="text" v-model="formRecord.c51" style="width:200px;"
                         :disabled='disabledoff || forbidden.c51'/>
                </FormItem>
              </td>
            </tr>
            <tr>
    ...
    <Modal v-model="modal5" class="basic-info pageStyle" :width=650 ok-text="保存" @on-ok="submitBasic" cancel-text="关闭">
      ...
      <div class="pro-info">
        ...
        型号的 <span class="f-product">家用太阳能热水系统 2011版</span>产品{{pageType==="update"?'已通过能效标识备案':''}}。
      </div>
        ...
        if (this.pageType === 'view') {
          ...
          return {
            ...
            c15: [
              ...
              {
                validator: this.formRecord.c14 == '平板型' ? twoDecimals : check,
                trigger: 'change,blur'
              }
            ],
            c16: [
