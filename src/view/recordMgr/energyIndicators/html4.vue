    ...
    <Form ref="formRecord" :model="formRecord" label-position="right" :rules="pageType!='extend'?ruleRecord:extendRule">
      ...
      <div class="part part5">
        ...
        <Card :bordered="false">
          ...
          <table id="table3">
            <tr>
              <td><span class="color-red">*</span>制热功能</td>
              <td>
                <FormItem prop="c56">
              ...
              <td><span class="color-red">*</span>制热量(瓦)</td>
              <td>
                <FormItem prop="c44">
            ...
            <tr>
              <td class="right-align"><span class="color-red">*</span>输入功率(瓦)</td>
              <td>
                <FormItem prop="c45">
                  <Input type="text" v-model="formRecord.c45" :disabled='disabledoff'/>
                </FormItem>
              </td>
              <td class="right-align"><span class="color-red">*</span>性能系数(COP)<br>(两位小数)
              </td>
              <td>
                <FormItem prop="c46">
