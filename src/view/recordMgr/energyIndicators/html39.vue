      ...
      <div class="part part6">
        <Card :bordered="false">
          ...
          <table id="table4">
            <thead>
            <tr>
              <th style="width:30%">名称</th><th style="width:35%">牌号及规格/型号</th><th style="width:35%">生产者（全称）</th>
            </tr>
            </thead>
            <tbody>
            <tr>
      ...
      let checkC21C40=(rule, value, callback) => {
        ...
        if (thiz.formRecord.c40=="全部都有") {
          ...
          if (thiz.formRecord.c21==5) {
            if (!(thiz.formRecord.c6 >= 15))  {thiz.checkC21C40Msg = _msg+"||全压效率（%）标称值 应该 >= 15";}
            if (!(thiz.formRecord.c9 <= 3.0)) {thiz.checkC21C40Msg = _msg+"||待机功率标称值 应该 <= 3.0";}
            if (!(thiz.formRecord.c12 <= 1.5)){thiz.checkC21C40Msg = _msg+"||关机功率标称值 应该 <= 1.5";}
            if (!(thiz.formRecord.c15 >= 90)) {thiz.checkC21C40Msg = _msg+"||常态气味降低度标称值 应该 >= 90";}
            if (!(thiz.formRecord.c18 >= 80)) {thiz.checkC21C40Msg = _msg+"||油脂分离度标称值 应该 >= 80";}
          } else if (thiz.formRecord.c21==4) {
            if (!(thiz.formRecord.c6 >= 17))  {thiz.checkC21C40Msg = _msg+"||全压效率（%）标称值 应该 >= 17";}
            if (!(thiz.formRecord.c9 <= 3.0)) {thiz.checkC21C40Msg = _msg+"||待机功率标称值 应该 <= 3.0";}
            if (!(thiz.formRecord.c12 <= 1.5)){thiz.checkC21C40Msg = _msg+"||关机功率标称值 应该 <= 1.5";}
            if (!(thiz.formRecord.c15 >= 90)) {thiz.checkC21C40Msg = _msg+"||常态气味降低度标称值 应该 >= 90";}
            if (!(thiz.formRecord.c18 >= 80)) {thiz.checkC21C40Msg = _msg+"||油脂分离度标称值 应该 >= 80";}
          } else if (thiz.formRecord.c21==3) {
            if (!(thiz.formRecord.c6 >= 19))  {thiz.checkC21C40Msg = _msg+"||全压效率（%）标称值 应该 >= 19";}
            if (!(thiz.formRecord.c9 <= 3.0)) {thiz.checkC21C40Msg = _msg+"||待机功率标称值 应该 <= 3.0";}
            if (!(thiz.formRecord.c12 <= 1.5)){thiz.checkC21C40Msg = _msg+"||关机功率标称值 应该 <= 1.5";}
            if (!(thiz.formRecord.c15 >= 90)) {thiz.checkC21C40Msg = _msg+"||常态气味降低度标称值 应该 >= 90";}
            if (!(thiz.formRecord.c18 >= 80)) {thiz.checkC21C40Msg = _msg+"||油脂分离度标称值 应该 >= 80";}
          } else if (thiz.formRecord.c21==2) {
            if (!(thiz.formRecord.c6 >= 21))  {thiz.checkC21C40Msg = _msg+"||全压效率（%）标称值 应该 >= 21";}
            if (!(thiz.formRecord.c9 <= 2.0)) {thiz.checkC21C40Msg = _msg+"||待机功率标称值 应该 <= 2.0";}
            if (!(thiz.formRecord.c12 <= 1.0)){thiz.checkC21C40Msg = _msg+"||关机功率标称值 应该 <= 1.0";}
            if (!(thiz.formRecord.c15 >= 95)) {thiz.checkC21C40Msg = _msg+"||常态气味降低度标称值 应该 >= 95";}
            if (!(thiz.formRecord.c18 >= 80)) {thiz.checkC21C40Msg = _msg+"||油脂分离度标称值 应该 >= 80";}
          } else if (thiz.formRecord.c21==1) {
            if (!(thiz.formRecord.c6 >= 23))  {thiz.checkC21C40Msg = _msg+"||全压效率（%）标称值 应该 >= 23";}
            if (!(thiz.formRecord.c9 <= 2.0)) {thiz.checkC21C40Msg = _msg+"||待机功率标称值 应该 <= 2.0";}
            if (!(thiz.formRecord.c12 <= 1.0)){thiz.checkC21C40Msg = _msg+"||关机功率标称值 应该 <= 1.0";}
            if (!(thiz.formRecord.c15 >= 95)) {thiz.checkC21C40Msg = _msg+"||常态气味降低度标称值 应该 >= 95";}
            if (!(thiz.formRecord.c18 >= 80)) {thiz.checkC21C40Msg = _msg+"||油脂分离度标称值 应该 >= 80";}
