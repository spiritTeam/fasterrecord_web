        ...
        <Card :bordered="false">
          ...
          <table id="table1">
            ...
            <tr>
              ...
              <td style="border-left:none;">
                <FormItem prop="c9">
                  <Input type="text" v-model="formRecord.c9" :disabled='disabledoff||forbidden.djgl'
                         placeholder="一位小数"/>
                </FormItem>
              </td>
              ...
              <td style="border-left:none;">
                <FormItem prop="c10">
                  <Input type="text" v-model="formRecord.c10" :disabled='disabledoff||forbidden.djgl'
                         placeholder="至少两位小数"/>
                </FormItem>
              </td>
              <td>
            ...
            <tr>
              ...
              <td style="border-left:none;">
                <FormItem prop="c12">
                  <Input type="text" v-model="formRecord.c12" :disabled='disabledoff||forbidden.gjgl'
                         placeholder="一位小数"/>
                </FormItem>
              </td>
              ...
              <td style="border-left:none;">
                <FormItem prop="c13">
                  <Input type="text" v-model="formRecord.c13" :disabled='disabledoff||forbidden.gjgl'
                         placeholder="至少两位小数"/>
                </FormItem>
              </td>
              <td>
      ...
      <div class="part part4">
        <Card :bordered="false">
          ...
          <FormItem prop="c22" label="备案标识开始使用日期" style="width:100%;">
            <DatePicker type="date" :Options="dataInit" style="width: 200px" v-model="formRecord.c22"
