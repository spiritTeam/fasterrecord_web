          ...
          <table class="table table-bordered dataTables-example dataTable bg-white"
            ...
            <tr>
              ...
              <td class="t1" colspan="2">
                <FormItem prop="c83">
                  <RadioGroup v-model="formRecord.c83">
                    <Radio label="环状阀 /网状阀" :disabled='disabledoff'>环状阀 /网状阀</Radio>
                    <Radio label="舌簧阀" :disabled='disabledoff'>舌簧阀</Radio>
                  </RadioGroup>
                </FormItem>
              </td>
              <td>
            ...
            <tr>
              ...
              <td class="t1" colspan="2">
                <FormItem prop="c87">
                  <RadioGroup v-model="formRecord.c87">
                    <Radio label="环状阀 /网状阀" :disabled='disabledoff'>环状阀 /网状阀</Radio>
                    <Radio label="舌簧阀" :disabled='disabledoff'>舌簧阀</Radio>
                  </RadioGroup>
                </FormItem>
