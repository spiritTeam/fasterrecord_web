        ...
        <Card :bordered="false">
          ...
          <table id="table1">
            <tr>
              ...
              <td>
                <FormItem prop="c50" label="实测值:" style="width:100%;" :label-width="70">
            ...
            <tr>
              ...
              <td>
                <FormItem prop="c51" label="实测值:" style="width:100%;" :label-width="70">
            ...
            <tr>
              ...
              <td>
                <FormItem prop="c52" label="实测值:" style="width:100%;" :label-width="70">
        ...
        <Card :bordered="false">
          ...
          <table id="table3">
            <tr>
              <th>名称</th>
              <th>规格型号</th>
              <th>制冷量(kW)<br>(一位小数)</th>
              <th>输入功率(kW)<br>(一位小数)</th>
              <th>COP值(两位小数)</th>
              <th>制造商(全称)</th>
            </tr>
            <tr>
              <td align="left"><span style="color:red">*</span>压缩机1</td>
              <td>
                <FormItem prop="c10" style="width:100%;">
                  <Input type="text" v-model="formRecord.c10" :disabled='disabledoff'/>
                </FormItem>
              </td>
              <td>
                <FormItem prop="c11" style="width:100%;">
                  <Input type="text" v-model="formRecord.c11" :disabled='disabledoff'/>
                </FormItem>
              </td>
              <td>
                <FormItem prop="c12" style="width:100%;">
            ...
            <tr>
              <td colspan="6" style="color:red">注：如果上述部件属多个制造商，均应按上述要求逐一填写。</td>
            </tr>
          </table>
          <h3>样品描述</h3>
          <table id="table3">
            <tr>
              <td align="right"><span style="color:red">*</span>机器类型</td>
              <td colspan="3">
                <FormItem prop="c20" style="width:100%;">
                  <RadioGroup v-model="formRecord.c20">
                    <Radio label="工商业用和类似用途" :disabled='disabledoff'>工商业用和类似用途</Radio>
                    <Radio label="户用和类似用途" :disabled='disabledoff'>户用和类似用途</Radio>
                  </RadioGroup>
                </FormItem>
              </td>
            </tr>
            ...
            <tr>
              <td align="right"><span style="color:red">*</span>压缩机</td>
              <td colspan="3">
                <FormItem prop="c22" style="width:100%;">
                  <RadioGroup v-model="formRecord.c22">
                    <Radio label="离心式" :disabled='disabledoff'>离心式</Radio>
                    <Radio label="单螺杆式" :disabled='disabledoff'>单螺杆式</Radio>
                    <Radio label="双螺杆式" :disabled='disabledoff'>双螺杆式</Radio>
                    <Radio label="活塞式" :disabled='disabledoff'>活塞式</Radio>
                    <Radio label="涡旋式" :disabled='disabledoff'>涡旋式</Radio>
                    <Radio label="滚动转子式" :disabled='disabledoff'>滚动转子式</Radio>
                  </RadioGroup>
                </FormItem>
              </td>
            </tr>
            <tr>
              <td rowspan="2" align="right"><span style="color:red">*</span>风机</td>
              <td colspan="3">
                <FormItem><label style="font-size:14px;">风量m³/h:</label></FormItem>
                <FormItem prop="c23" style="width:200px;">
                  <Input type="text" v-model="formRecord.c23" :disabled='disabledoff'/>
                </FormItem>
                <FormItem><label style="font-size:14px;">输入功率W:</label></FormItem>
                <FormItem prop="c24" style="width:200px;">
            ...
            <tr>
              <td colspan="3">
                <FormItem><label style="font-size:14px;">全压Pa:</label></FormItem>
                <FormItem prop="c25" style="width:200px;">
                  <Input type="text" v-model="formRecord.c25" :disabled='disabledoff'/>
                </FormItem>
              </td>
            </tr>
            <tr>
              <td align="right"><span style="color:red">*</span>翅片式换热器</td>
              <td colspan="3">
                <FormItem><label style="font-size:14px;">换热面积 ㎡:</label></FormItem>
                <FormItem prop="c46" style="width:200px;">
                  <Input type="text" v-model="formRecord.c46" :disabled='disabledoff'/>
                </FormItem>
                <FormItem><label style="font-size:14px;">铜管直径mm:</label></FormItem>
            ...
            <tr>
              <td align="right"><span style="color:red">*</span>换热器换热管表面积(㎡)</td>
              <td>
                <FormItem prop="c26" style="width:200px;">
            ...
            <tr>
              <td align="right"><span style="color:red">*</span>其它载冷剂</td>
              <td>
            ...
            <tr>
              <td align="right"><span style="color:red">*</span>换热器(水/制冷剂)</td>
              <td colspan="3">
                <FormItem prop="c32">
              ...
              <td colspan="3">
                <FormItem prop="c33">
                  <RadioGroup v-model="formRecord.c33">
                    ...
                    <Radio label="电动膨胀阀" :disabled='disabledoff'>电动膨胀阀</Radio>
                    <Radio label="毛细管" :disabled='disabledoff'>毛细管</Radio>
                    <Radio label="其他" :disabled='disabledoff'>其他</Radio>
                  </RadioGroup>
                </FormItem>
                <FormItem prop="c59">
                    <Input type="text" v-model="formRecord.c59" :disabled='disabledoff' style="width:200px;"/>
                </FormItem>
              </td>
            </tr>
            <tr>
              ...
              <td colspan="3">
                <FormItem prop="c37">
                  <RadioGroup v-model="formRecord.c37">
                    ...
                    <Radio label="交流6000V" :disabled='disabledoff'>交流6000V</Radio>
                    <Radio label="交流10000V" :disabled='disabledoff'>交流10000V</Radio>
                    <Radio label="直流" :disabled='disabledoff'>直流</Radio>
                    <Radio label="其它" :disabled='disabledoff'>其它</Radio>
                  </RadioGroup>
                </FormItem>
                <FormItem prop="c60">
                  <Input type="text" v-model="formRecord.c60" :disabled='disabledoff' style="width:200px;"/>
                </FormItem>
              </td>
            </tr>
            <tr>
              ...
              <td colspan="3">
                ...
                <FormItem prop="c61">
                  <Input type="text" v-model="formRecord.c61" :disabled='disabledoff' style="width:200px;"/>
                </FormItem>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td colspan="3">
                ...
                <FormItem prop="c66" style="width:200px;">
                  <Input type="text" v-model="formRecord.c66" :disabled='disabledoff'/>
                </FormItem>
              </td>
            </tr>
            <tr>
              <td align="right"><span style="color:red">*</span>净重(kg)</td>
              <td colspan="3">
                <FormItem prop="c68" style="width:200px;">
                  <Input type="text" v-model="formRecord.c68" :disabled='disabledoff'/>
                </FormItem>
              </td>
            </tr>
            <tr>
              <td align="right"><span style="color:red">*</span>整机或室内机外形尺寸<br>(长×宽×高)<br>(mm×mm×mm)</td>
              <td>
                <FormItem prop="c40" style="width:80px;">
                  <Input type="text" v-model="formRecord.c40" :disabled='disabledoff'/>
                </FormItem>
                <FormItem><b>×</b></FormItem>
                <FormItem prop="c62" style="width:80px;">
                  <Input type="text" v-model="formRecord.c62" :disabled='disabledoff'/>
                </FormItem>
                <FormItem><b>×</b></FormItem>
                <FormItem prop="c63" style="width:80px;">
                  <Input type="text" v-model="formRecord.c63" :disabled='disabledoff'/>
                </FormItem>
              </td>
              <td align="right">室外机外形尺寸<br>(长×宽×高)(mm×mm×mm)</td>
              <td>
                <FormItem prop="c48" style="width:80px;">
                  <Input type="text" v-model="formRecord.c48" :disabled='disabledoff'/>
                </FormItem>
                <FormItem><b>×</b></FormItem>
                <FormItem prop="c64" style="width:80px;">
                  <Input type="text" v-model="formRecord.c64" :disabled='disabledoff'/>
                </FormItem>
                <FormItem><b>×</b></FormItem>
                <FormItem prop="c65" style="width:80px;">
          ...
          <table id="table3">
            <tr>
              ...
              <td>
                <FormItem prop="c67" style="width:100%;">
                  <RadioGroup v-model="formRecord.c67">
                    <Radio label="有" :disabled='disabledoff'>有</Radio>
                    <Radio label="无" :disabled='disabledoff'>无</Radio>
                  </RadioGroup>
                </FormItem>
              </td>
              <td align="right"><span style="color:red">*</span>制热量(千瓦)</td>
              <td>
            ...
            <tr>
              <td align="right"><span style="color:red">*</span>热泵制热消耗总<br>电功率(千瓦)</td>
              <td>
                <FormItem prop="c43" style="width:100%;">
                  <Input type="text" v-model="formRecord.c43" :disabled='disabledoff'/>
                </FormItem>
              </td>
              <td align="right"><span style="color:red">*</span>性能系数(COP)<br>(两位小数)</td>
              <td>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      ruleRecord() {
        //制冷量
        var c50=this.formRecord.c50;
        var c5=this.formRecord.c5;
        const checkc50 = (rule, value, callback) => {
          if(c50 != "" && c5 != ""){
              if ((parseFloat(c5) * 0.95) > parseFloat(c50)) {
                callback('制冷量实测值应大于等于制冷量标准规定值的95%！')
              }else{
                callback()
              }
          }else{
        ...
        const checkc51 = (rule, value, callback) => {
          if(c51 != "" && c6 != ""){
              if (parseFloat(c51) > (parseFloat(c6) * 1.1)) {
                callback('消耗总电功率实测值应小于等于消耗总电功率标准规定值的110%！')
              }else{
                callback()
              }
          }else{
        ...
        var nxdj = 0;
        var c21=this.formRecord.c21;
        if(c21 != "" && c5 != ""){
          if (c21 == "水冷") {
            if (parseFloat(c5) > 1163) {
                if (cop >= 6.1) {
                    nxdj = 1;
                } else if (cop >= 5.6) {
                    nxdj = 2;
