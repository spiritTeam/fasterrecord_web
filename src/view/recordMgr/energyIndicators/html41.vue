  ...
  <div class="wrapper">
            ...
            <tr>
              ...
              <td>
                ...
                <FormItem prop="c28" style="width:80px;" :label-width="0">
                  <Input type="text" v-model="formRecord.c28"
                         :disabled='disabledoff || forbidden.c28 || forbidden.zcrqccz'/>
                </FormItem>
              ...
              <td>
                ...
                <FormItem prop="c30" style="width:80px;" :label-width="0">
                  <Input type="text" v-model="formRecord.c30"
                         :disabled='disabledoff || forbidden.c30 || forbidden.yyrqdgz'/>
                </FormItem>
                <FormItem>眼灶</FormItem>
              </td>
              <td align="center">/</td>
              ...
              <td>
                <FormItem prop="c34">
                  <CheckboxGroup v-model="formRecord.c34">
                    ...
                    <Checkbox label="离子感应式" :disabled='disabledoff || forbidden.zcrqccz'>离子感应式</Checkbox>
                    <br>
                ...
                <FormItem prop="c35" style="width:120px;margin-top:30px;margin-left:-115px;" :label-width="0">
                  <Input type="text" v-model="formRecord.c35"
                         :disabled='disabledoff || forbidden.c35 || forbidden.zcrqccz'/>
                </FormItem>
              ...
              <td>
                <FormItem prop="c36">
                  <CheckboxGroup v-model="formRecord.c36">
                    ...
                    <Checkbox label="离子感应式" :disabled='disabledoff || forbidden.yyrqdgz'>离子感应式</Checkbox>
                    <br>
                ...
                <FormItem prop="c37" style="width:120px;margin-top:30px;margin-left:-115px;" :label-width="0">
                  <Input type="text" v-model="formRecord.c37"
                         :disabled='disabledoff || forbidden.c37 || forbidden.yyrqdgz'/>
                </FormItem>
              ...
              <td>
                <FormItem prop="c38">
                  <CheckboxGroup v-model="formRecord.c38">
                    ...
                    <Checkbox label="离子感应式" :disabled='disabledoff || forbidden.rqzx'>离子感应式</Checkbox>
                    <br>
                ...
                <FormItem prop="c39" style="width:120px;margin-top:30px;margin-left:-115px;" :label-width="0">
                  <Input type="text" v-model="formRecord.c39"
                         :disabled='disabledoff || forbidden.c39 || forbidden.rqzx'/>
                </FormItem>
                <FormItem style="margin-top:30px;">(必选)</FormItem>
              </td>
            </tr>
            <tr>
              ...
              <td>
                ...
                <FormItem prop="c11" label="额定热负荷(kW能效标识标注值):" style="width:100%;margin-top:20px;" :label-width="130">
                  <Input type="text" v-model="formRecord.c11" :disabled='disabledoff || forbidden.zcrqccz'
              ...
              <td>
                ...
                <FormItem prop="c49" label="额定热负荷(kW能效标识标注值):" style="width:100%;margin-top:20px;" :label-width="130">
                  <Input type="text" v-model="formRecord.c49" :disabled='disabledoff || forbidden.yyrqdgz'
                         style="margin-top:10px;"/>
                </FormItem>
      ...
      <div class="part part6">
        <Card :bordered="false">
          ...
          <table id="table4">
            ...
            <tr>
              <td colspan="7">注：如上述零部件属多个生产者，均应按上述要求逐一填写。</td>
            </tr>
          </table>
        </Card>
      </div>
    ...
    <Modal v-model="modal5" class="basic-info pageStyle" :width=650 ok-text="保存" @on-ok="submitBasic" cancel-text="关闭">
      ...
      <div class="pro-info">
        ...
        型号的 <span class="f-product">商用燃气灶具 2014版</span>产品{{pageType==="update"?'已通过能效标识备案':''}}。
      </div>
