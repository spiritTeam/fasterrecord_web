...
public class HttpsUtils {
	...
	//private static String[] sslArray = { "SSLv2Hello", "SSLv3", "TLSv1", "TLSv1.2" };
	private static String[] sslArray = { "SSLv3", "TLSv1", "TLSv1.2" };
	
	public static void main(String[]args) {
		String url = "https://www.energylabelrecord.com:12066/fast/getPreNum.do";
		try {
			String re = HttpsUtils.get(url);
	...
	static {
		try {
			...
			sslsf = new SSLConnectionSocketFactory(builder.build(), sslArray, null, NoopHostnameVerifier.INSTANCE);
